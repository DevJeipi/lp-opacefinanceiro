...
export const metadata: Metadata = {
    title: 'Curso Do Cheque Especial à Independência Financeira | Módulo 03',
    description:
        'Conheça mais a fundo as aulas que serão oferecidas no módulo 03 do curso.',
    alternates: {
        canonical: 'https://opacefinanceiro.com.br/modulo03',
    },
    ...
    openGraph: {
        ...
        description:
            'Conheça mais a fundo as aulas que serão oferecidas no módulo 03 do curso.',
        url: 'https://opacefinanceiro.com.br/modulo03',
    },
            ...
            <section className="bg-primary-blue">
                <GridContainer className="flex flex-col items-center justify-center gap-8">
                    ...
                    <div className="flex flex-col items-center justify-center gap-4">
                        ...
                        >
                            <source
                                src="/modulo03-corte-lp-opacefinanceiro.mp4"
                                type="video/mp4"
                            />
