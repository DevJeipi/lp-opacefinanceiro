                    ...
                    <div className="mt-8 flex max-w-207 flex-col gap-12">
                        ...
                        <div className="font-body flex flex-col sm:flex-row sm:pl-14">
                            ...
                            <div className="mt-2 flex flex-col items-start justify-center gap-2 pl-4 text-left sm:mt-0 sm:px-8">
                                ...
                                <p className="text-primary-white/80">
                                    ...
                                    dominar seus gastos com um sistema simples
                                    que te dá controle total sobre seu dinheiro
                                    - o primeiro passo para nunca mais viver no
                                    aperto!
                                </p>
                            </div>
                        </div>
                        ...
                        <div className="font-body flex flex-col sm:flex-row sm:pl-14">
                            ...
                            <div className="mt-2 flex flex-col items-start justify-center gap-2 pl-4 text-left sm:mt-0 sm:px-8">
                                ...
                                <p className="text-primary-white/80">
                                    ...
                                    Descubra estratégias poderosas para cortar
                                    gastos desnecessários e aumentar sua renda -
                                    sem sacrificar o que você ama!
                                </p>
                            </div>
                        </div>
                        ...
                        <div className="font-body flex flex-col sm:flex-row sm:pl-14">
                            ...
                            <div className="mt-2 flex flex-col items-start justify-center gap-2 pl-4 text-left sm:mt-0 sm:px-8">
                                ...
                                <p className="text-primary-white/80">
                                    ...
                                    protegido! Crie uma reserva poderosa que te
                                    salva de qualquer imprevisto - a base para
                                    sua paz financeira!
                                </p>
                            </div>
                        </div>
                        ...
                        <div className="font-body flex flex-col sm:flex-row sm:pl-14">
                            ...
                            <div className="mt-2 flex flex-col items-start justify-center gap-2 pl-4 text-left sm:mt-0 sm:px-8">
                                ...
                                <p className="text-primary-white/80">
                                    Livre-se das correntes das dívidas de uma
                                    vez por todas! Conheça o plano infalível
                                    para eliminar juros altos e recuperar sua
                                    liberdade financeira - rápido!
                                </p>
                            </div>
                        </div>
                        ...
                        <div className="font-body flex flex-col sm:flex-row sm:pl-14">
                            ...
                            <div className="mt-2 flex flex-col items-start justify-center gap-2 pl-4 text-left sm:mt-0 sm:px-8">
                                ...
                                <p className="text-primary-white/80">
                                    ...
                                    nunca! Aprenda a expandir sua proteção para
                                    enfrentar qualquer desafio - e viver sem
                                    medo do futuro!
                                </p>
                            </div>
                        </div>
                        ...
                        <div className="font-body flex flex-col sm:flex-row sm:pl-14">
                            ...
                            <div className="mt-2 flex flex-col items-start justify-center gap-2 pl-4 text-left sm:mt-0 sm:px-8">
                                ...
                                <p className="text-primary-white/80">
                                    ...
                                    confiança e construir um futuro de riqueza -
                        ...
                        <div className="font-body flex flex-col sm:flex-row sm:pl-14">
                            ...
                            <div className="mt-2 flex flex-col items-start justify-center gap-2 pl-4 text-left sm:mt-0 sm:px-8">
                                ...
                                <p className="text-primary-white/80">
                                    Mantenha seu dinheiro crescendo sem esforço!
                                    Aprenda a ajustar seus investimentos com
                                    facilidade e garanta que seu plano esteja
                        ...
                        <div className="font-body flex flex-col sm:flex-row sm:pl-14">
                            ...
                            <div className="mt-2 flex flex-col items-start justify-center gap-2 pl-4 text-left sm:mt-0 sm:px-8">
                                ...
                                <p className="text-primary-white/80">
                                    Viva a vida dos seus sonhos! Descubra como
                                    alcançar a liberdade financeira e trabalhar
                                    apenas por prazer - o destino final da sua
                                    jornada está aqui!
                                </p>
                            </div>
                        </div>
